# Felipe Barbosa Santos &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; [![Portfolio](https://img.shields.io/badge/Portfolio-Visit-6C3EF5?style=for-the-badge)](https://felipebsa.github.io/)
...
Looking for a backend internship opportunity, where I can apply my skills in Python, APIs and databases while keeping growing as a developer.
...
![Alembic](https://img.shields.io/badge/Alembic-2F4F4F?style=flat-square)
...
PC assembly, component diagnostics, notebook maintenance and formatting.
...
| [Backend-Learning](https://github.com/felipebsa/Backend-Learning) | Backend development journey — FastAPI, SQLAlchemy 2.0, full CRUD, project structure | Python · FastAPI · SQLAlchemy · Alembic · Pytest |
...
- **Silver Medal** — OBMASP (São Paulo State Schools Math Olympiad, Level 3) — 18/20
- **Bronze Medal** — OLISP (Olympiad Interpreta SP, Level 3) — 17/20
- **Honorable Mention** — OBMEP (Brazilian Math Olympiad for Public Schools, Level 3, Phase 2)
- **Highlight** — OLITEF (Financial Education Olympiad, Level 3) — 68/74
